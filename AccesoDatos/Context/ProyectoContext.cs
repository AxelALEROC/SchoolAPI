...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-M09B7ONF\\SQLEXPRESS;Database=Proyecto;Trust Server Certificate=True;User Id=Admin;Password=Admin;MultipleActiveResultSets=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F142C66FA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F192F8BF5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F6D493504");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F137BFCE0");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7E69118C0");
